...
@Component({
  selector: 'app-buddyrequest-confirm',
  templateUrl: './buddyrequest-confirm.component.html',
  styleUrls: ['./buddyrequest-confirm.component.css']
})
export class BuddyrequestConfirmComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.active.queryParams.subscribe((params) => {
      ...
      this.buddyService.confirm(id, token).subscribe(() => {
          this.success = true;
